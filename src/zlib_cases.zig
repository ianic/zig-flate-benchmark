...
pub const cases = [_]Case{
    .{
        .data = @embedFile("bench_data/ziglang.tar.z"),
        .bytes = 177244160,
    },
    .{
        .data = @embedFile("bench_data/war_and_peace.txt.z"),
        .bytes = 3359630,
    },
    .{
        .data = @embedFile("bench_data/large.tar.z"),
        .bytes = 11162624,
    },
    .{
        .data = @embedFile("bench_data/cantrbry.tar.z"),
        .bytes = 2821120,
    },
    .{
        .data = @embedFile("bench_data/empty.z"),
        .bytes = 1073741824,
    },
    .{
        .data = @embedFile("bench_data/images.tar.z"),
        .bytes = 16711680,
    },
};
